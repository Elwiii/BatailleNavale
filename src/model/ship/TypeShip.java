...
public enum TypeShip implements Serializable {
    ...
    CRUSADER(6, new Color(155, 200, 255)), HUNTER(3, new Color(100, 200, 255)), MOTHER(7, new Color(155, 200, 255)), VIPER(2, new Color(155, 200, 0)), GALLION(8, new Color(155, 100, 255)), BARQUE(5, new Color(0, 100, 0)), GALERE(6, new Color(155, 100, 255)), TRANSPORT(2, new Color(155, 255, 255)), CROISEUR(6, new Color(255, 100, 255)), FREGATE(5, new Color(255, 66, 255)), JETSKI(2, new Color(255, 100, 255)), PORTEAVION(10, new Color(5, 100, 0)), SOUSMARIN(3, new Color(255, 26, 255));
